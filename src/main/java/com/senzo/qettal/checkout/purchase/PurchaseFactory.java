...
public class PurchaseFactory {
	...
	public Optional<Purchase> create(PurchaseDTO purchaseDTO) {
		try{
			...
			Purchase purchase = new Purchase(loggedUser.getUser().get(), event.getName(), event.getDescription(), event.getImage(), event.getScheduledDate(), event.getTheaterId(), event.getTheaterName(), event.getTheaterAddress());
